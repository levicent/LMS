...
export const ConfirmationDialog: React.FC<ConfirmationDialogProps> = ({ isOpen, onClose, onConfirm, title, message }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-gray-300 dark:bg-gray-600 p-6 rounded shadow-lg">
        <h2 className="text-xl dark:font-bold mb-4 text-black dark:text-white">{title}</h2>
        <p className="mb-4 text-black font-bold dark:text-gray-300">{message}</p>
