...
import { BookOpenIcon, ClockIcon, UserIcon, ArrowLeftIcon } from '@heroicons/react/20/solid';
...
const CategoryPage: React.FC = () => {
  ...
  const { data: courses, isLoading, error } = useFetchCoursesByCategory(category || '');
  const handleGoBack = () => {
    navigate(-1); 
  };
  ...
  if (isLoading) {
    return (
      <DefaultLayout>
        <div 
          className={`container mx-auto py-8 min-h-screen flex justify-center items-center ${
              ...
              <CardContent>
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  >
                    ...
                    <span className="text-sm"> {course.instructor.firstName}{" "}</span>
                  </div>
                  <div 
                    className={`flex items-center ${
                      theme === 'dark' ? 'text-gray-400' : 'text-gray-500'
